...
?>
  <div class="dadication-content adopt-a-child">
    <div class="row">
      ...
      <a style="text-decoration:none; float:right; color:#256224; font-weight: bold; cursor:pointer; margin-bottom: 5px;" data-toggle="modal" data-target=".bs-example-modal-lg_<?php echo get_the_id(); ?>">
